...
<div class="container">
    ...
    <div class="form-container" style="text-align:center;">
        <form name="frmContact" id="" frmContact"" method="post"
            ...
            <div class="input-row">
                <label>Confirm Password</label> <span id="subjectp-info"
                    class="info"></span><br /> <input type="password"
                    class="input-field" name="subjectp" id="subjectp" />
            </div>
    ...
    <script type="text/javascript">
        function validateContactForm() {
            ...
            if (subjectp == "") {
                $("#subjectp-info").html("Required.");
                $("#subjectp").css('border', '#e66262 1px solid');
                valid = false;
            }
            if (subject != subjectp) {
                $("#subjectp-info").html("Incorrect password.");
                $("#subjectp").css('border', '#e66262 1px solid');
                valid = false;
            }
            if (content == "") {
